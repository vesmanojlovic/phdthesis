...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Chapter_trajectories/figures/non-spatial-temporal.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Chapter_trajectories/figures/gland-temporal.pdf}
