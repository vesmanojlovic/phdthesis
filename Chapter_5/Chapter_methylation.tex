\chapter{Inferring evolutionary parameters of colorectal cancer from DNA methylation arrays}\label{chapter:methylation}
\large\textbf{OUTLINE}
\begin{itemize}
...
%         models of tumour evolution \cite{niida_modeling_2021}.
...
%         way in which the tumour grows \cite{preston_bottom-up_2003}. The
%         assumption of neutrality in the spatial branching process is consistent
%         with the findings of \cite{sottoriva_big_2015}.
% \end{enumerate}
