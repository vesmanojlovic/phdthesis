\chapter{Tracking modes of cancer evolution \textit{in silico} via tree shape
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{Chapter_3/figures/all_replicates.pdf}
...
During the analysis, I found that patterns observed in the new index space are
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{Chapter_3/figures/new_trajs1.png}
